...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "ext-app-file-out-tabular-format"
...
variable "application_build_labels" {
  ...
  type        = map(string)
  default = {
    "org.opencontainers.image.title"       = "FileOutputTabularFormat Extension App Reference Implementation"
    ...
    "org.opencontainers.image.source"      = "https://github.com/docusign/extension-app-file-output-tabular-format-reference-implementation-private"
