# File Output Tabular Format Extension App Reference Implementation
## Introduction

This reference implementation for an extension app that handles tabular data operations, focusing specifically on file-based input/output operations.

## Setup instructions
### 1. Clone the repository
Run the following command to clone the repository: 
```bash
git clone https://github.com/docusign/extension-app-file-output-tabular-format-reference-implementation.git
```
...
### 3. Upload your manifest and create the File Export Tabular Format app
[Create your extension app](https://developers.docusign.com/extension-apps/build-an-extension-app/create/) and [Test your extension](https://developers.docusign.com/extension-apps/build-an-extension-app/test/). 
